...
**Branch:** `wave-8-bld-13-3-welcome-calls` (Wave 8 in progress)

**Last completed:** BLD-13.3 — Welcome Call detail page + enhanced queue ✅

**Overall completion: ~57%** (Wave 8 partial — BLD-13.2 + BLD-13.3 done)
...
| BLD-14.3 | Order Detail — NICE CG189 checklist gate | 🔲 Next |
| BLD-14.4 | Order Detail — dose escalation gate | 🔲 Next |
| BLD-14.5 | Order Detail — weight trajectory card | 🔲 Next |

**Wave 8 remaining priority:**
1. Order Detail gates: NICE checklist (BLD-14.3), dose escalation (BLD-14.4), weight trajectory (BLD-14.5)
2. Owner Dashboard full rebuild — content beyond MHRA rollup card
3. KPI Dashboard (BLD-12.x) — stub only, Wave 12 content
4. G6 Flag Dashboard (BLD-16.6) — stub only, Wave 16 content
5. BLD-9.0 Monday write client — unblocks complaint sync + audit pipeline
