...
**Branch:** `wave-10-clinical-tightening` (Wave 10 COMPLETE)

**Last completed:** Clinical tightening pass — queue age badge, three-gate approval enforcement, ED safeguarding banner ✅
...
|---|---|---|
| BLD-15.1 | Queue age badge on clinical check queue rows (green/amber/red by SLA thresholds) | ✅ Done |
| BLD-14.2 | Three-gate Clinical Check enforcement — Approve blocked if NICE checklist incomplete, dose escalation unacknowledged, or weight history missing | ✅ Done |
