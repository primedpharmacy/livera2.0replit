...
**Branch:** `main` (HEAD: `4672e13`)

**Last completed wave:** Wave 6.5 — Patient profile 9-tab rewrite (merged to main)

**Overall completion: ~46%** (as of 2026-05-13 gap analysis)

**Next priority — Wave 7 Gap-Close** (all have completed prototypes, none built):

| BLD | Description | Size | Prototype URL |
|---|---|---|---|
| BLD-YC-01 | MHRA Yellow Card panel in incident detail | S | `livera_scr_incident_detail_intercom` |
| BLD-INT-MHRA-02 | Intercom tag-actions settings update | S | `livera_scr_intercom_webhook_config` |
