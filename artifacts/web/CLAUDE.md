...
**Branch:** `wave-8-bld-14-order-detail-foundation` (Wave 8 in progress)

**Last completed:** Order Detail foundation fixes — left panel rebuild + questionnaire regression + default tab ✅

**Overall completion: ~63%** (Wave 8 partial — BLD-13.2, BLD-13.3, BLD-14.3, BLD-14.4, BLD-14.5 + foundation fixes done)
...
|---|---|---|
| BLD-13.2 | Tasks list + detail (full surface) | ✅ Done |
| BLD-13.3 | Welcome Call detail + enhanced queue | ✅ Done |
| BLD-14.3 | Order Detail — NICE CG189 checklist gate | ✅ Done |
| BLD-14.4 | Order Detail — dose escalation gate | ✅ Done |
| BLD-14.5 | Order Detail — weight trajectory card | ✅ Done |

**Wave 8 remaining priority:**
1. Owner Dashboard full rebuild — content beyond MHRA rollup card
2. KPI Dashboard (BLD-12.x) — stub only, Wave 12 content
3. G6 Flag Dashboard (BLD-16.6) — stub only, Wave 16 content
4. BLD-9.0 Monday write client — unblocks complaint sync + audit pipeline
