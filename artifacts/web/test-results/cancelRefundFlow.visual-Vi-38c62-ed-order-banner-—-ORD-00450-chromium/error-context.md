...
Locator: locator('div').filter({ hasText: /Order cancelled —/ }).first()
  Expected an image 1280px by 1424px, received 1280px by 1469px. 88924 pixels (ratio 0.05 of all image pixels) are different.
...
Call log:
  ...
  - Expected an image 1280px by 1424px, received 1280px by 1469px. 40599 pixels (ratio 0.03 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 67599 pixels (ratio 0.04 of all image pixels) are different.
